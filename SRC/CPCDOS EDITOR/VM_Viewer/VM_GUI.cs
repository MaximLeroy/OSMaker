...
namespace OSMaker.VM_Viewer
{
    public partial class VM_GUI : DocumentC
    {
        ...
        {
            btnStop_Click(null, null); //Maybe click?
        }
    ...
    BackgroundWorker bw2 = new BackgroundWorker();
        ...
        private void fLauchVMX(string _sPath)
        {
            ...
            if (_sPath == "" || !cbFullScreen.Checked)
            { //Normal Mode
        ...
        private void VM_GUI_FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {
               if( MessageBox.Show("Unmount ? (Recommanded)", "OSMaker - VM Viewer", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                
                    fUnMount(metroTextBox1.Text);
        ...
        private void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            Home.m_solutionExplorer.txtDirectory.Text = drivepath + Barreoblique.Text;
           Home.m_solutionExplorer.Recharger();
            metroTextBox1.Text = drivepath;
           // timer1.Start();
        }

        public void EditDrive( string dirDrive)
        {
            ...
            if (WinApi.GetFullPathFromWindows("imdisk.exe") != null)
            {
                ...
                string _sPath = dirDrive;
                drivepath = dirDrive;
                cbDrive.Text = dirDrive;
        ...
        public void Stop()
        {
            oKvmAction = new LauchTool();
            oKvmAction.bOutput = false;
            oKvmAction.fLauchExe(sVM_Path + "vmwareplayer.exe", "--power-off " + "\"" + sLauched_Path + "\"");
